...
juce::String HeadlessBatchRunner::buildHelpText()
{
    return
        ...
        "\n"
        "Usage:\n"
        "  OctaChainer2.exe --headless --sourcefolder <folder> --targetfolder <folder>\n"
        "                       --chainbasename <name> --samplerate <rate>\n"
        "                       --bitdepth <depth> --channels <count> [options]\n"
        "\n"
        "Options:\n"
        ...
        "  --msslicefadein       Fade-in per slice in milliseconds (valid: 1, 2, 3, 5, 10)\n"
        "  --msslicefadeout      Fade-out per slice in milliseconds (valid: 1, 2, 3, 5, 10)\n"
